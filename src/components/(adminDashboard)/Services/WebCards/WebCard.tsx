...
const WebCard = ({ carddata }: { carddata: TSubService }) => {
    ...
    return (
            ...
            <div className='flex flex-row items-center gap-x-3 w-full' ref={setNodeRef} {...attributes} style={style} >
                <div className='p-5 bg-white shadow border-t-2 border-main-color flex flex-row gap-x-5 items-center rounded-lg justify-between  cursor-default w-full'>
                    <div className='w-2/3'>
